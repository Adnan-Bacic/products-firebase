            ...
            <div class="col-12">
                ...
                <form v-on:submit.prevent="AddNewProduct()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Have the mouse in here and press escape to delete the image" class="form-control" @keydown.escape.prevent="deleteImage()" v-model="deleteImgBtn">
                        <p class="text-danger font-weight-bolder" v-if="imageDeletedResponse">{{ imageDeletedResponse }}</p>
                    ...
                    <button type="submit" class="btn btn-success btn-lg btn-block mt-3 mb-3">Create</button>
                </form>
            </div>
        </div>
    </div>
...
export default {
    ...
    data(){
        return{
            ...
            //imgsrc: null,
            price: null,
            available: false, //default value to false. or else the db type is null an the output is empty is null
            tags: [],
            anotherTag: null,
        ...
        uploadImage() {
            ...
            * 100;
            ...
            deleteImage(){
                    ...
                    imageDeletedResponse = 'Image deleted'
